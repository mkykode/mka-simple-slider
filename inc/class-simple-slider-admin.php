...
class SimpleSliderAdmin {
	 ...
	 *
	 * @param SimpleSliderOptions $options options.
	 *
	 * @param string $text_domain Text domain.
	 *
	 * @internal param string $text_domain Text domain.
	 */
	public function __construct( SimpleSliderOptions $options, $text_domain ) {
	...
	public static function register_post_type() {
		SliderPostType::run( self::$text_domain );
	}
	 ...
	 * Run init.
	 *
	 * @param SimpleSliderOptions $options Array.
	 * @param string $text_domain Text domain.
	 */
	public static function run( SimpleSliderOptions $options, $text_domain ) {
